    ...
    if (mouseIsPressed == true) {
        ...
        if (dist(mouseX, mouseY, x_s, y_s) < d_s / 2 && mouseButton == LEFT) {
            ...
            for (let i = 0; i < left.length; i++) {
                ...
                left[i].addCue(left[i].duration(), left.stop());
            }

            for (let i = 0; i < right.length; i++) {

                right[i].addCue(right[i].duration(), right.stop());
            }
    ...
    if (mouseIsPressed == true) {
        ...
        if (dist(mouseX, mouseY, x_p, y_p) < d_p / 2 && mouseButton == LEFT) {
            ...
            for (let i = 0; i < left.length; i++) {
                ...
                left[i].addCue(left[i].duration(), left.loop());
                left[i].setVolume(0);
            ...
            for (let i = 0; i < right.length; i++) {
                ...
                right[i].addCue(right[i].duration(), right.loop());
                right[i].setVolume(0);
